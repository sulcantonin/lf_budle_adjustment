...
%% Note: this function uses absolute two-plane parametrization
%
% (c) Bastian Goldluecke 11/2014, University of Konstanz
% License: Creative Commons BY-SA 4.0
%          Please cite our paper if you use our code in your work.
%
function [X] = lf_unproject_absolute( ray, d, f )

    X = zeros(3,1);
    X(3) = f / d;
    X(1) = (ray(1) - ray(3)) * X(3) / f + ray(3);
    X(2) = (ray(2) - ray(4)) * X(3) / f + ray(4);
